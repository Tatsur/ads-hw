...
public class TreeImpl<E extends Comparable<? super E>> implements Tree<E> {
    ...
    public void display() {
        ...
        char[] delimiterV = new char[nBlanks*2];
        Arrays.fill(delimiterV, '_');
        delimiter.append(delimiterV);
    ...
    private int level(Node<E> node) {
        return node == null ? 0 : 1 + Math.max(level(node.getLeftChild()), level(node.getRightChild()));
    }
